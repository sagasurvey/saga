...
def read_ukst(file_path):
    ...
    specs['SPEC_Z'] = specs['RV'].astype(np.float64) / _SPEED_OF_LIGHT
    del specs['RV']
    specs['SPEC_Z_ERR'] = 100 / _SPEED_OF_LIGHT
    specs['ZQUALITY'] = 4
    specs['TELNAME'] = 'UKST'
    specs['HELIO_CORR'] = True
...
def read_lcrs(file_path):
    ...
    specs['SPEC_Z'] = specs['cz'].astype(np.float64) / _SPEED_OF_LIGHT
    specs['SPEC_Z_ERR'] = specs['e_cz'].astype(np.float64) / _SPEED_OF_LIGHT
    del specs['cz'], specs['e_cz']
